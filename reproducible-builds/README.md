...
In the following section, we will use signal-cli version 0.14.1 as the reference example. Simply replace all occurrences of 0.14.1 with the version number you are about to verify.
...
```bash
git clone --depth 1 --branch v0.14.1 https://github.com/AsamK/signal-cli
cd ./signal-cli
