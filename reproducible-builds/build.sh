...
$ENGINE build --build-arg=SOURCE_DATE_EPOCH=$SOURCE_DATE_EPOCH -t signal-cli:build -f reproducible-builds/build.Containerfile .
$ENGINE build --build-arg=SOURCE_DATE_EPOCH=$SOURCE_DATE_EPOCH -t signal-cli:native -f reproducible-builds/native.Containerfile .
$ENGINE build --build-arg=SOURCE_DATE_EPOCH=$SOURCE_DATE_EPOCH -t signal-cli:client -f reproducible-builds/client.Containerfile .
